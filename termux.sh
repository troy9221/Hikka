...
eval "cd && git clone https://github.com/troy9221/Hikka && cd Hikka"
...
if [[ -z "${NO_AUTOSTART}" ]]; then
    ...
    echo 'clear && . <(wget -qO- https://github.com/troy9221/Hikka/raw/master/banner.sh) && cd ~/Hikka && python3 -m hikka' > ~/.bash_profile"
